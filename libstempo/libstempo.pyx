...
cdef class tempopulsar:
    ...
    def pars(self,which='fit'):
        ...
        elif isinstance(which,collectionsAbc.Iterable):
    ...
    #     TODO: possibly implement the full (nonmutable) dict interface by way of collectionsAbc.Mapping
    ...
    def vals(self,values=None,which='fit'):
        ...
        elif isinstance(values,collectionsAbc.Mapping):
            for par in values:
                self.pardict[par].val = values[par]
        elif isinstance(values,collectionsAbc.Iterable):
